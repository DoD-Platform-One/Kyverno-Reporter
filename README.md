...
| monitoring.serviceMonitor.scheme | string | `"https"` |  |
...
| monitoring.kyverno.serviceMonitor.enabled | bool | `false` |  |
| monitoring.kyverno.serviceMonitor.namespace | string | `""` |  |
| monitoring.kyverno.serviceMonitor.scheme | string | `"https"` |  |
| monitoring.kyverno.serviceMonitor.tlsConfig | object | `{}` |  |
| monitoring.kyverno.serviceMonitor.honorLabels | bool | `false` |  |
| monitoring.kyverno.serviceMonitor.scrapeTimeout | string | `""` |  |
| monitoring.kyverno.serviceMonitor.interval | string | `""` |  |
| monitoring.kyverno.serviceMonitor.labels | object | `{}` |  |
| monitoring.kyverno.serviceMonitor.namespaceSelector | object | `{}` |  |
| monitoring.kyverno.serviceMonitor.relabelings | list | `[]` |  |
| monitoring.kyverno.serviceMonitor.metricRelabelings | list | `[]` |  |
